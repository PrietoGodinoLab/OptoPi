...
void loop() 
{
  ...
  // RGB MATRICES SET COLOR
  Set_Matrix_Color_Off();
...
void Set_Matrix_Color_Green()
  {
    //Red color Matrix 1
   matrix_1.fillScreen(matrix_1.Color(0, 255, 0));
   matrix_1.show();
  
   //Red color Matrix 2
   matrix_2.fillScreen(matrix_2.Color(0, 255, 0));
   matrix_2.show();
  
//   //Red color Matrix 3
//   matrix_3.fillScreen(matrix_3.Color(0, 255, 0));
//   matrix_3.show();
//  
//   //Red color Matrix 4
//   matrix_4.fillScreen(matrix_4.Color(0,255, 0));
//   matrix_4.show();
  }
...
void Set_Matrix_Color_Blue()
  {
   //Blue color Matrix 1
   matrix_1.fillScreen(matrix_1.Color(0, 0, 255));
   matrix_1.show();

   //Blue color Matrix 2
   matrix_2.fillScreen(matrix_2.Color(0, 0, 255));
   matrix_2.show();

   //Blue color Matrix 3
   //matrix_3.fillScreen(matrix_3.Color(0, 0, 225));
   //matrix_3.show();

   //Blue color Matrix 4
   //matrix_4.fillScreen(matrix_4.Color(0, 0, 225));
   //matrix_4.show();
  }

  void Set_Matrix_Color_Off()
  {
   //Blue color Matrix 1
